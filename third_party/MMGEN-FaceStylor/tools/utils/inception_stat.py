...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgsdir',
                        type=str,
                        default=None,
                        help='the dir containing images.')
    parser.add_argument('--data-cfg',
                        type=str,
                        default=None,
                        help='the config file for test data pipeline')
    parser.add_argument('--pklname',
                        type=str,
                        help='the name of inception pkl')
    parser.add_argument('--pkl-dir',
                        type=str,
    ...
    parser.add_argument('--flip',
                        action='store_true',
                        help='whether to flip real images')
    ...
    parser.add_argument('--inception-style',
                        choices=['stylegan', 'pytorch'],
                        default='pytorch',
                        help='which inception network to use')
    parser.add_argument('--inception-pth',
                        type=str,
